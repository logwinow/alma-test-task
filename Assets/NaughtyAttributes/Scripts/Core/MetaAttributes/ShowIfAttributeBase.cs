...
namespace NaughtyAttributes
{
    public class ShowIfAttributeBase : MetaAttribute
    {
        ...
        public (string Name, bool Value)[] ComplexConditions { get; private set; }
        ...
        public ShowIfAttributeBase(string[] names, bool[] values)
        {
            ConditionOperator = EConditionOperator.And;
            ComplexConditions = names.Zip(values, (name, value) => (name, value)).ToArray();
        }
